!function (a, b) {
    ...
    */}, c.normalizeData = function (a, b, d) {
    ...
    c.Interpolation = {}, c.Interpolation.none = function (a) {
      ...
      return function b(f, g) {
        var h = c.splitIntoSegments(f, g, {fillHoles: a.fillHoles});
        if (h.length) {
          if (h.length > 1) {
            var i = [];
          ...
          for (var j = (new c.Svg.Path).move(f[0], f[1], !1, g[0]), k = 0, l = f.length; l - 2 > k; k += 2) {
            var m = [{x: +f[k - 2], y: +f[k - 1]}, {x: +f[k], y: +f[k + 1]}, {
              x: +f[k + 2],
              y: +f[k + 3]
            }, {x: +f[k + 4], y: +f[k + 5]}];
            l - 4 === k ? m[3] = m[2] : k || (m[0] = {
      ...
      var b = {fillHoles: !1};
      return a = c.extend({}, b, a), function b(d, e) {
        var f = c.splitIntoSegments(d, e, {fillHoles: a.fillHoles, increasingX: !0});
        if (f.length) {
          if (f.length > 1) {
            var g = [];
          ...
          var h, i, j = [], k = [], l = d.length / 2, m = [], n = [], o = [], p = [];
  ...
  return function (a, b, c) {
    "use strict";
    var d = {axisTitle: "", axisClass: "ct-axis-title", offset: {x: 0, y: 0}, textAnchor: "middle", flipText: !1},
      e = {xAxis: d, yAxis: d};
    c.plugins = c.plugins || {}, c.plugins.ctAxisTitle = function (a) {
      return a = c.extend({}, e, a), function (b) {
  ...
  return a.plugins = a.plugins || {}, a.plugins.legend = function (c) {
    ...
    return c = a.extend({}, b, c), e && (c.position = e), function (b) {
   /*   var e = b.container.querySelector(".ct-legend");
      if (e && e.parentNode.removeChild(e), c.clickable) {
        var f = b.data.series.map(function (c, d) {
          return "object" != typeof c && (c = {value: c}), c.className = c.className || b.options.classNames.series + "-" + a.alphaNumerate(d), c
        });
        b.data.series = f
      }
      var g = document.createElement("ul"), h = b instanceof a.Pie;
      ...
      var i = [], j = b.data.series.slice(0), k = b.data.series, l = h && b.data.labels;
      if (l) {
      ...
      k.forEach(function (a, b) {
        ...
        if (c.position instanceof HTMLElement) c.position.insertBefore(g, null); else switch (c.position) {
          case"top":
        ...
        if (e.parentNode === g && e.hasAttribute("data-legend")) {
          a.preventDefault();
          var f = parseInt(e.getAttribute("data-legend")), h = i.indexOf(f);
          if (h > -1) i.splice(h, 1), e.classList.remove("inactive"); else if (c.removeAll) i.push(f), e.classList.add("inactive"); else if (b.data.series.length > 1) i.push(f), e.classList.add("inactive"); else {
            i = [];
  ...
  return function a(b, c, d) {
    ...
    1: [function (a, b, c) {
    ...
    }, {5: 5}], 2: [function (a, b, c) {
      var d = a(4), e = a(1), f = function (a) {
        ...
        var b;
        if ("string" == typeof a) if (b = e.getRgba(a)) this.setValues("rgb", b); else if (b = e.getHsla(a)) this.setValues("hsl", b); else {
          if (!(b = e.getHwb(a))) throw new Error('Unable to parse color from string "' + a + '"');
          this.setValues("hwb", b)
        } else if ("object" == typeof a) if (b = a, void 0 !== b.r || void 0 !== b.red) this.setValues("rgb", b); else if (void 0 !== b.l || void 0 !== b.lightness) this.setValues("hsl", b); else if (void 0 !== b.v || void 0 !== b.value) this.setValues("hsv", b); else if (void 0 !== b.w || void 0 !== b.whiteness) this.setValues("hwb", b); else {
      ...
      f.prototype = {
        rgb: function () {
          ...
          var b = this.values.hsl, c = (b[0] + a) % 360;
          return b[0] = c < 0 ? 360 + c : c, this.setValues("hsl", b), this
        }, mix: function (a, b) {
          var c = this, d = a, e = void 0 === b ? .5 : b, f = 2 * e - 1, g = c.alpha() - d.alpha(),
          ...
          var a, b, c = new f, d = this.values, e = c.values;
        ...
        var c, e = this.values, f = this.spaces, g = this.maxes, h = 1;
        if ("alpha" === a) h = b; else if (b.length) e[a] = b.slice(0, a.length), h = b[a.length]; else if (void 0 !== b[a.charAt(0)]) {
    ...
    }, {1: 1, 4: 4}], 3: [function (a, c, d) {
      function e(a) {
        var b, c, d, e = a[0] / 255, f = a[1] / 255, g = a[2] / 255, h = Math.min(e, f, g), i = Math.max(e, f, g),
          j = i - h;
      ...
      function h(a) {
        var b = a[0], c = a[1], d = a[2], f = e(a)[0], g = 1 / 255 * Math.min(b, Math.min(c, d)),
      ...
      function l(a) {
        var b, c, d, e = k(a), f = e[0], g = e[1], h = e[2];
      ...
      function t(a) {
        var b = a[0] / 60, c = a[1] / 100, d = a[2] / 100, e = Math.floor(b) % 6, f = b - Math.floor(b),
          g = 255 * d * (1 - c), h = 255 * d * (1 - c * f), i = 255 * d * (1 - c * (1 - f)), d = 255 * d;
        switch (e) {
          case 0:
            return [d, i, g];
          case 1:
      ...
      function y(a) {
        var c, d, e, f, h = a[0] / 360, i = a[1] / 100, j = a[2] / 100, k = i + j;
      ...
      for (var f in d) {
        ...
        var g = /(\w+)2(\w+)/.exec(f), h = g[1], i = g[2];
      ...
      j.prototype.routeSpace = function (a, b) {
        ...
        var b = this.convs[a];
        if (!b) {
          var c = this.space, d = this.convs[c];
      ...
      !function (b, e) {
        ...
        function n(a) {
          if (null == a._isValid) {
            var b = m(a), c = od.call(b.parsedDateParts, function (a) {
              return null != a
            });
        ...
        function N(a) {
          var b = [];
          for (var c in a) b.push({unit: c, priority: zd[c]});
        ...
        function ja(a, b) {
          ...
          if ("string" == typeof b) if (/^\d+$/.test(b)) b = u(b); else if ("number" != typeof(b = a.localeData().monthsParse(b))) return a;
        ...
        function eb(a) {
          var b, c, d, e, f, g, h = a._i, i = we.exec(h) || xe.exec(h);
          if (i) {
            for (m(a).iso = !0, b = 0, c = ze.length; b < c; b++) if (ze[b][1].exec(i[1])) {
              e = ze[b][0], d = !1 !== ze[b][2];
              break
            }
            if (null == e) return void(a._isValid = !1);
            if (i[3]) {
              for (b = 0, c = Ae.length; b < c; b++) if (Ae[b][1].exec(i[3])) {
                f = (i[2] || " ") + Ae[b][0];
                break
              }
        ...
        function pb(a) {
          var b = a._i, c = a._f;
          return a._locale = a._locale || bb(a._l), null === b || void 0 === c && "" === b ? o({nullInput: !0}) : ("string" == typeof b && (a._i = b = a._locale.preparse(b)), s(b) ? new r(db(b)) : (d(c) ? mb(a) : g(b) ? a._d = b : c ? kb(a) : qb(a), n(a) || (a._d = null), a))
        }
        ...
        function zb(a, b) {
          var c = (b || "").match(a) || [], d = c[c.length - 1] || [], e = (d + "").match(Fe) || ["-", 0, 0],
            f = 60 * e[1] + u(e[2]);
          return "+" === e[0] ? f : -f
        }
        ...
        function Tb(b, c, d, e) {
          var f = c._milliseconds, g = Rb(c._days), h = Rb(c._months);
        ...
        function Vb(b, c) {
          var d = b || sb(), e = Ab(d, this).startOf("day"), f = a.calendarFormat(this, e) || "sameElse",
        ...
        function id(a, b, c) {
          var d = Nb(a).abs(), e = hf(d.as("s")), f = hf(d.as("m")), g = hf(d.as("h")), h = hf(d.as("d")),
            i = hf(d.as("M")), j = hf(d.as("y")),
        ...
        function ld(a) {
          var b = this.localeData(), c = id(this, !a, b);
          return a && (c = b.pastFuture(+this, c)), b.postformat(c)
        }

        function md() {
          var a, b, c, d = kf(this._milliseconds) / 1e3, e = kf(this._days), f = kf(this._months);
        ...
        var pd = a.momentProperties = [], qd = !1, rd = {};
        ...
        var td, ud = {
          ...
          Bd = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, Cd = {}, Dd = {}, Ed = /\d/, Fd = /\d\d/, Gd = /\d{3}/,
          Hd = /\d{4}/, Id = /[+-]?\d{6}/, Jd = /\d\d?/, Kd = /\d\d\d\d?/, Ld = /\d\d\d\d\d\d?/, Md = /\d{1,3}/,
          Nd = /\d{1,4}/, Od = /[+-]?\d{1,6}/, Pd = /\d+/, Qd = /[+-]?\d+/, Rd = /Z|[+-]\d\d:?\d\d/gi,
          Sd = /Z|[+-]\d\d(?::?\d\d)?/gi, Td = /[+-]?\d+(\.\d{1,3})?/,
          Ud = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,
          Vd = {}, Wd = {}, Xd = 0, Yd = 1, Zd = 2, $d = 3, _d = 4, ae = 5, be = 6, ce = 7, de = 8;
        ...
        var ee = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,
          ...
          ge = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), he = Ud, ie = Ud;
        U("Y", 0, 0, function () {
          var a = this.year();
          return a <= 9999 ? "" + a : "+" + a
        }), U(0, ["YY", 2], 0, function () {
        ...
        var le = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
          me = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), ne = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), oe = Ud, pe = Ud,
          qe = Ud;
        ...
        var re, se = /[ap]\.?m?\.?/i, te = O("Hours", !0), ue = {
            calendar: ud,
            longDateFormat: vd,
          ...
          Ae = [["HH:mm:ss.SSSS", /\d\d:\d\d:\d\d\.\d+/], ["HH:mm:ss,SSSS", /\d\d:\d\d:\d\d,\d+/], ["HH:mm:ss", /\d\d:\d\d:\d\d/], ["HH:mm", /\d\d:\d\d/], ["HHmmss.SSSS", /\d\d\d\d\d\d\.\d+/], ["HHmmss,SSSS", /\d\d\d\d\d\d,\d+/], ["HHmmss", /\d\d\d\d\d\d/], ["HHmm", /\d\d\d\d/], ["HH", /\d\d/]],
          Be = /^\/?Date\((\-?\d+)/i;
        ...
        Nb.fn = wb.prototype;
        var Ie = Sb(1, "add"), Je = Sb(-1, "subtract");
        ...
        var Te = Math.abs, Ue = dd("ms"), Ve = dd("s"), We = dd("m"), Xe = dd("h"), Ye = dd("d"), Ze = dd("w"),
          $e = dd("M"), _e = dd("y"), af = fd("milliseconds"), bf = fd("seconds"), cf = fd("minutes"), df = fd("hours"),
          ef = fd("days"), ff = fd("months"), gf = fd("years"), hf = Math.round,
          jf = {s: 45, m: 45, h: 22, d: 26, M: 11}, kf = Math.abs, lf = wb.prototype;
      ...
      b.exports = function (a) {
        a.Radar = function (b, c) {
          return c.options = a.helpers.configMerge({aspectRatio: 1}, c.options), c.type = "radar", new a(b, c)
        }
      }
    }, {}], 14: [function (a, b, c) {
      "use strict";
      ...
      b.exports = function (a) {
        ...
        a.defaults.bar = {
          ...
          updateElement: function (a, c, d) {
            var e = this, f = e.getMeta(), g = e.getScaleForId(f.xAxisID), h = e.getScaleForId(f.yAxisID),
              i = h.getBasePixel(), j = e.chart.options.elements.rectangle, k = a.custom || {}, l = e.getDataset();
            b.extend(a, {
              _xScale: g,
              _yScale: h,
          ...
          getRuler: function (a) {
            var b, c = this, d = c.getMeta(), e = c.getScaleForId(d.xAxisID), f = c.getBarCount();
            b = "category" === e.options.type ? e.getPixelForTick(a + 1) - e.getPixelForTick(a) : e.width / e.ticks.length;
            var g = b * e.options.categoryPercentage, h = (b - b * e.options.categoryPercentage) / 2, i = g / f;
          ...
          calculateBarX: function (a, b) {
            var c = this, d = c.getMeta(), e = c.getScaleForId(d.xAxisID), f = c.getBarIndex(b), g = c.getRuler(a),
          ...
          calculateBarY: function (a, b) {
            var c = this, d = c.getMeta(), e = c.getScaleForId(d.yAxisID), f = Number(c.getDataset().data[a]);
            if (e.options.stacked) {
              for (var g = 0, h = 0, i = 0; i < b; i++) {
                var j = c.chart.data.datasets[i], k = c.chart.getDatasetMeta(i);
          ...
          setHoverStyle: function (a) {
            var c = this.chart.data.datasets[a._datasetIndex], d = a._index, e = a.custom || {}, f = a._model;
          ...
          updateElement: function (a, c, d) {
            var e = this, f = e.getMeta(), g = e.getScaleForId(f.xAxisID), h = e.getScaleForId(f.yAxisID),
              i = g.getBasePixel(), j = a.custom || {}, k = e.getDataset(), l = e.chart.options.elements.rectangle;
            b.extend(a, {
              _xScale: g,
              _yScale: h,
              _datasetIndex: e.index,
              ...
              draw: function () {
                ...
                var b = this._chart.ctx, c = this._view, d = c.height / 2, e = c.y - d, f = c.y + d,
                  g = c.base - (c.base - c.x), h = c.borderWidth / 2;
            ...
            var c = this, d = c.getMeta(), e = c.getScaleForId(d.xAxisID), f = 0;
            if (e.options.stacked) {
              for (var g = c.chart, h = g.data.datasets, i = Number(h[a].data[b]), j = 0; j < a; j++) {
                var k = h[j], l = g.getDatasetMeta(j);
            ...
            var b, c = this, d = c.getMeta(), e = c.getScaleForId(d.yAxisID), f = c.getBarCount();
            b = "category" === e.options.type ? e.getPixelForTick(a + 1) - e.getPixelForTick(a) : e.width / e.ticks.length;
            var g = b * e.options.categoryPercentage, h = (b - b * e.options.categoryPercentage) / 2, i = g / f;
            if (e.ticks.length !== c.chart.data.labels.length) {
              i *= e.ticks.length / c.chart.data.labels.length
            ...
            var b = this, c = b.getScaleForId(b.getMeta().yAxisID);
            if (c.options.barThickness) return c.options.barThickness;
            var d = b.getRuler(a);
            return c.options.stacked ? d.categoryHeight : d.barHeight
          }, calculateBarX: function (a, b) {
            var c = this, d = c.getMeta(), e = c.getScaleForId(d.xAxisID), f = Number(c.getDataset().data[a]);
            if (e.options.stacked) {
              for (var g = 0, h = 0, i = 0; i < b; i++) {
                var j = c.chart.data.datasets[i], k = c.chart.getDatasetMeta(i);
            ...
            var c = this, d = c.getMeta(), e = c.getScaleForId(d.yAxisID), f = c.getBarIndex(b), g = c.getRuler(a),
              h = e.getPixelForValue(null, a, b, c.chart.isCombo);
      ...
      b.exports = function (a) {
        ...
        a.defaults.bubble = {
          ...
          dataElementType: a.elements.Point, update: function (a) {
            var c = this, d = c.getMeta(), e = d.data;
            b.each(e, function (b, d) {
              c.updateElement(b, d, a)
            })
          }, updateElement: function (c, d, e) {
            var f = this, g = f.getMeta(), h = f.getScaleForId(g.xAxisID), i = f.getScaleForId(g.yAxisID),
              j = c.custom || {}, k = f.getDataset(), l = k.data[d], m = f.chart.options.elements.point, n = f.index;
            b.extend(c, {
              _xScale: h,
              _yScale: i,
              _datasetIndex: n,
            ...
            var e = d.chart.data.datasets[c._datasetIndex], f = c._index, g = c.custom || {};
            ...
            var d = c.chart.data.datasets[b._datasetIndex].data[b._index], e = b.custom || {};
      ...
      b.exports = function (a) {
        ...
        c.doughnut = {
          ...
          legendCallback: function (a) {
            ...
            var c = a.data, d = c.datasets, e = c.labels;
            if (d.length) for (var f = 0; f < d[0].data.length; ++f) b.push('<li><span style="background-color:' + d[0].backgroundColor[f] + '"></span>'), e[f] && b.push(e[f]), b.push("</li>");
            ...
            labels: {
              generateLabels: function (a) {
                ...
                return c.labels.length && c.datasets.length ? c.labels.map(function (d, e) {
                  var f = a.getDatasetMeta(0), g = c.datasets[0], h = f.data[e], i = h && h.custom || {},
                    j = b.getValueAtIndexOrDefault, k = a.options.elements.arc;
                  return {
                    text: d,
              ...
              var c, d, e, f = b.index, g = this.chart;
        ...
        }, c.pie = b.clone(c.doughnut), b.extend(c.pie, {cutoutPercentage: 0}), a.controllers.doughnut = a.controllers.pie = a.DatasetController.extend({
          ...
          update: function (a) {
            var c = this, d = c.chart, e = d.chartArea, f = d.options, g = f.elements.arc,
              h = e.right - e.left - g.borderWidth, i = e.bottom - e.top - g.borderWidth, j = Math.min(h, i),
              k = {x: 0, y: 0}, l = c.getMeta(), m = f.cutoutPercentage, n = f.circumference;
            if (n < 2 * Math.PI) {
              var o = f.rotation % (2 * Math.PI);
              o += 2 * Math.PI * (o >= Math.PI ? -1 : o < -Math.PI ? 1 : 0);
              var p = o + n, q = {x: Math.cos(o), y: Math.sin(o)}, r = {x: Math.cos(p), y: Math.sin(p)},
                ...
                v = o <= .5 * -Math.PI && .5 * -Math.PI <= p || o <= 1.5 * Math.PI && 1.5 * Math.PI <= p, w = m / 100,
                x = {
                ...
                }, z = {width: .5 * (y.x - x.x), height: .5 * (y.y - x.y)};
              j = Math.min(h / z.width, i / z.height), k = {x: -.5 * (y.x + x.x), y: -.5 * (y.y + x.y)}
            }
          ...
          updateElement: function (a, c, d) {
            var e = this, f = e.chart, g = f.chartArea, h = f.options, i = h.animation, j = (g.left + g.right) / 2,
              k = (g.top + g.bottom) / 2, l = h.rotation, m = h.rotation, n = e.getDataset(),
              o = d && i.animateRotate ? 0 : a.hidden ? 0 : e.calculateCircumference(n.data[c]) * (h.circumference / (2 * Math.PI)),
              p = d && i.animateScale ? 0 : e.innerRadius, q = d && i.animateScale ? 0 : e.outerRadius,
          ...
          calculateTotal: function () {
            var a, c = this.getDataset(), d = this.getMeta(), e = 0;
      ...
      b.exports = function (a) {
        ...
        a.defaults.line = {
          ...
          addElementAndReset: function (c) {
            var d = this, e = d.chart.options, f = d.getMeta();
          ...
          update: function (a) {
            var d, e, f, g = this, h = g.getMeta(), i = h.dataset, j = h.data || [], k = g.chart.options,
              l = k.elements.line, m = g.getScaleForId(h.yAxisID), n = g.getDataset(), o = b(n, k);
          ...
          getPointBackgroundColor: function (a, b) {
            var d = this.chart.options.elements.point.backgroundColor, e = this.getDataset(), f = a.custom || {};
          ...
          getPointBorderColor: function (a, b) {
            var d = this.chart.options.elements.point.borderColor, e = this.getDataset(), f = a.custom || {};
          ...
          getPointBorderWidth: function (a, b) {
            var d = this.chart.options.elements.point.borderWidth, e = this.getDataset(), f = a.custom || {};
          ...
          updateElement: function (a, b, d) {
            var e, f, g = this, h = g.getMeta(), i = a.custom || {}, j = g.getDataset(), k = g.index, l = j.data[b],
              m = g.getScaleForId(h.yAxisID), n = g.getScaleForId(h.xAxisID), o = g.chart.options.elements.point;
          ...
          calculatePointY: function (a, b, c) {
            var d, e, f, g = this, h = g.chart, i = g.getMeta(), j = g.getScaleForId(i.yAxisID), k = 0, l = 0;
            if (j.options.stacked) {
              for (d = 0; d < c; d++) if (e = h.data.datasets[d], f = h.getDatasetMeta(d), "line" === f.type && f.yAxisID === j.id && h.isDatasetVisible(d)) {
          ...
          updateBezierControlPoints: function () {
            ...
            var b, d, e, f, g, h = this, i = h.getMeta(), j = h.chart.chartArea,
          ...
          draw: function (a) {
            var c, d, e = this, f = e.getMeta(), g = f.data || [], h = a || 1;
          ...
          setHoverStyle: function (a) {
            var b = this.chart.data.datasets[a._datasetIndex], d = a._index, e = a.custom || {}, f = a._model;
          ...
          removeHoverStyle: function (a) {
            var b = this, d = b.chart.data.datasets[a._datasetIndex], e = a._index, f = a.custom || {}, g = a._model;
      ...
      b.exports = function (a) {
        ...
        a.defaults.polarArea = {
          ...
          legendCallback: function (a) {
            ...
            b.push('<ul class="' + a.id + '-legend">');
            var c = a.data, d = c.datasets, e = c.labels;
            if (d.length) for (var f = 0; f < d[0].data.length; ++f) b.push('<li><span style="background-color:' + d[0].backgroundColor[f] + '">'), e[f] && b.push(e[f]), b.push("</span></li>");
            return b.push("</ul>"), b.join("")
          },
          legend: {
            labels: {
              generateLabels: function (a) {
                var c = a.data;
                return c.labels.length && c.datasets.length ? c.labels.map(function (d, e) {
                  var f = a.getDatasetMeta(0), g = c.datasets[0], h = f.data[e], i = h.custom || {},
                    j = b.getValueAtIndexOrDefault, k = a.options.elements.arc;
                  return {
                    text: d,
                    fillStyle: i.backgroundColor ? i.backgroundColor : j(g.backgroundColor, e, k.backgroundColor),
          ...
          linkScales: b.noop,
          update: function (a) {
            var c = this, d = c.chart, e = d.chartArea, f = c.getMeta(), g = d.options, h = g.elements.arc,
          ...
          updateElement: function (a, c, d) {
            ...
            var s = h.startAngle, t = a.hidden ? 0 : j.getDistanceFromCenterForValue(g.data[c]), u = s + m * p,
              v = u + (a.hidden ? 0 : m), w = i.animateScale ? 0 : j.getDistanceFromCenterForValue(g.data[c]);
            b.extend(a, {
              _datasetIndex: e.index,
              _index: c,
              _scale: j,
          ...
          countVisibleElements: function () {
            var a = this.getDataset(), c = this.getMeta(), d = 0;
      ...
      b.exports = function (a) {
        ...
        a.defaults.radar = {
          ...
          update: function (a) {
            var c = this, d = c.getMeta(), e = d.dataset, f = d.data, g = e.custom || {}, h = c.getDataset(),
              i = c.chart.options.elements.line, j = c.chart.scale;
          ...
          updateElement: function (a, c, d) {
            var e = this, f = a.custom || {}, g = e.getDataset(), h = e.chart.scale, i = e.chart.options.elements.point,
          ...
          updateBezierControlPoints: function () {
            var a = this.chart.chartArea, c = this.getMeta();
          ...
          setHoverStyle: function (a) {
            var c = this.chart.data.datasets[a._datasetIndex], d = a.custom || {}, e = a._index, f = a._model;
      ...
      b.exports = function (a) {
        ...
        a.defaults.global.animation = {
          ...
          addAnimation: function (a, b, c, d) {
            var e = this;
            d || (a.animating = !0);
            for (var f = 0; f < e.animations.length; ++f) if (e.animations[f].chartInstance === a) return void(e.animations[f].animationObject = b);
            e.animations.push({
              chartInstance: a,
              animationObject: b
          ...
          startDigest: function () {
            ...
            var e = Date.now(), f = (e - b) / a.frameDuration;
      ...
      b.exports = function (a) {
        ...
        a.types = {}, a.instances = {}, a.controllers = {}, a.Controller = function (c) {
          ...
          initialize: function () {
            ...
            var d = this, e = d.chart, f = e.canvas, g = b.getMaximumWidth(f), h = e.aspectRatio,
            ...
            var a = this.options, c = a.scales || {}, d = a.scale;
            ...
            var c = this, d = c.options, e = c.scales = {}, f = [];
            ...
            }))), d.scale && f.push({options: d.scale, dtype: "radialLinear", isDefault: !0}), b.each(f, function (d) {
              var f = d.options, g = b.getValueOrDefault(f.type, d.dtype), h = a.scaleService.getScaleConstructor(g);
              if (h) {
                var i = new h({id: f.id, options: f, ctx: c.chart.ctx, chart: c});
            ...
            }, c), d.length > 1) for (var f = 1; f < d.length; f++) if (d[f] !== d[f - 1]) {
              c.isCombo = !0;
              break
            }
            return e
            ...
            if (f && (void 0 !== c && 0 !== c || void 0 === c && 0 !== f.duration)) {
              ...
              g.numSteps = (c || f.duration) / 16.66, g.easing = f.easing, g.render = function (a, c) {
                var d = b.easingEffects[c.easing], e = c.currentStep / c.numSteps, f = d(e);
            ...
            var c = this, d = b.getRelativePosition(a, c.chart), e = [];
            ...
            var c = this, d = b.getRelativePosition(a, c.chart), e = [], f = function () {
              if (c.data.datasets) for (var a = 0; a < c.data.datasets.length; a++) {
                var b = c.getDatasetMeta(a);
                if (c.isDatasetVisible(a)) for (var e = 0; e < b.data.length; e++) if (b.data[e].inRange(d.x, d.y)) return b.data[e]
              }
            }.call(c);
            return f ? (b.each(c.data.datasets, function (a, b) {
              if (c.isDatasetVisible(b)) {
                var d = c.getDatasetMeta(b), g = d.data[f._index];
            ...
            var c = this, d = b.getRelativePosition(a, c.chart), e = [], f = function () {
              if (c.data.datasets) for (var a = 0; a < c.data.datasets.length; a++) {
                var b = c.getDatasetMeta(a);
                if (c.isDatasetVisible(a)) for (var e = 0; e < b.data.length; e++) if (b.data[e].inLabelRange(d.x, d.y)) return b.data[e]
              }
            }.call(c);
            return f ? (b.each(c.data.datasets, function (a, d) {
              if (c.isDatasetVisible(d)) {
                var g = c.getDatasetMeta(d), h = b.findIndex(g.data, function (a) {
            ...
            var b = this, c = b.data.datasets[a];
            c._meta || (c._meta = {});
            var d = c._meta[b.id];
            ...
            var c = this, d = c.tooltip, e = c.options || {}, f = e.hover, g = e.tooltips;
      ...
      b.exports = function (a) {
        ...
        a.DatasetController = function (a, b) {
          ...
          linkScales: function () {
            var a = this, b = a.getMeta(), c = a.getDataset();
          ...
          createMetaDataset: function () {
            var a = this, b = a.datasetElementType;
            return b && new b({_chart: a.chart.chart, _datasetIndex: a.index})
          },
          createMetaData: function (a) {
            var b = this, c = b.dataElementType;
            return c && new c({_chart: b.chart.chart, _datasetIndex: b.index, _index: a})
          },
          addElements: function () {
            var a, b, c = this, d = c.getMeta(), e = c.getDataset().data || [], f = d.data;
          ...
          addElementAndReset: function (a) {
            var b = this, c = b.createMetaData(a);
            b.getMeta().data.splice(a, 0, c), b.updateElement(c, a, !0)
          },
          buildOrUpdateElements: function () {
            var a = this.getMeta(), b = a.data, c = this.getDataset().data.length, d = b.length;
            if (c < d) b.splice(c, d - c); else if (c > d) for (var e = d; e < c; ++e) this.addElementAndReset(e)
          },
          update: c,
          draw: function (a) {
            var c = a || 1;
          ...
          removeHoverStyle: function (a, c) {
            var d = this.chart.data.datasets[a._datasetIndex], e = a._index, f = a.custom || {},
              g = b.getValueAtIndexOrDefault, h = a._model;
          ...
          setHoverStyle: function (a) {
            var c = this.chart.data.datasets[a._datasetIndex], d = a._index, e = a.custom || {},
              f = b.getValueAtIndexOrDefault, g = b.getHoverColor, h = a._model;
        ...
        a.elements = {}, a.Element = function (a) {
          ...
          initialize: function () {
            ...
            return c._view || (c._view = b.clone(c._model)), 1 === a ? (c._view = c._model, c._start = null, c) : (c._start || c.pivot(), b.each(c._model, function (d, e) {
              if ("_" === e[0]) ; else if (c._view.hasOwnProperty(e)) if (d === c._view[e]) ; else if ("string" == typeof d) try {
              ...
              } else c._view[e] = d; else "number" != typeof d || isNaN(c._view[e]) ? c._view[e] = d : c._view[e] = d * a
            }, c), c)
      ...
      b.exports = function (a) {
        ...
        function e(a, d, e) {
          var f = document.defaultView, g = a.parentNode, h = f.getComputedStyle(a)[d], i = f.getComputedStyle(g)[d],
            j = c(h), k = c(i), l = Number.POSITIVE_INFINITY;
        ...
        f.each = function (a, b, c, d) {
          var e, g;
          if (f.isArray(a)) if (g = a.length, d) for (e = g - 1; e >= 0; e--) b.call(c, a[e], e); else for (e = 0; e < g; e++) b.call(c, a[e], e); else if ("object" == typeof a) {
            var h = Object.keys(a);
          ...
          return f.each(Array.prototype.slice.call(arguments, 1), function (b) {
            f.each(b, function (b, d) {
              if ("scales" === d) c[d] = f.scaleMerge(c.hasOwnProperty(d) ? c[d] : {}, b); else if ("scale" === d) c[d] = f.configMerge(c.hasOwnProperty(d) ? c[d] : {}, a.scaleService.getScaleDefaults(b.type), b); else if (c.hasOwnProperty(d) && f.isArray(c[d]) && f.isArray(b)) {
                var e = c[d];
          ...
          c = void 0 === c ? a : c;
          for (var d = 0, e = a.length; d < e; ++d) if (b.call(c, a[d], d, a)) return d;
          return -1
          ...
          var c = b.x - a.x, d = b.y - a.y, e = Math.sqrt(c * c + d * d), f = Math.atan2(d, c);
          return f < -.5 * Math.PI && (f += 2 * Math.PI), {angle: f, distance: e}
        }, f.aliasPixel = function (a) {
          return a % 2 == 0 ? 0 : .5
        }, f.splineCurve = function (a, b, c, d) {
          var e = a.skip ? b : a, f = b, g = c.skip ? b : c,
            h = Math.sqrt(Math.pow(f.x - e.x, 2) + Math.pow(f.y - e.y, 2)),
            i = Math.sqrt(Math.pow(g.x - f.x, 2) + Math.pow(g.y - f.y, 2)), j = h / (h + i), k = i / (h + i);
          ...
          var c = Math.floor(f.log10(a)), d = a / Math.pow(10, c);
        ...
        f.requestAnimFrame = function () {
          ...
          var c, d, e = a.originalEvent || a, g = a.currentTarget || a.srcElement, h = g.getBoundingClientRect(),
            i = e.touches;
          i && i.length > 0 ? (c = i[0].clientX, d = i[0].clientY) : (c = e.clientX, d = e.clientY);
          var j = parseFloat(f.getStyle(g, "padding-left")), k = parseFloat(f.getStyle(g, "padding-top")),
            l = parseFloat(f.getStyle(g, "padding-right")), m = parseFloat(f.getStyle(g, "padding-bottom")),
            n = h.right - h.left - j - l, o = h.bottom - h.top - k - m;
          ...
          var b = a.parentNode, c = parseInt(f.getStyle(b, "padding-left")) + parseInt(f.getStyle(b, "padding-right")),
            d = b.clientWidth - c, e = f.getConstraintWidth(a);
          return isNaN(e) ? d : Math.min(d, e)
        }, f.getMaximumHeight = function (a) {
          var b = a.parentNode, c = parseInt(f.getStyle(b, "padding-top")) + parseInt(f.getStyle(b, "padding-bottom")),
            d = b.clientHeight - c, e = f.getConstraintHeight(a);
          return isNaN(e) ? d : Math.min(d, e)
          ...
          var b = a.ctx, c = a.canvas, d = c.width, e = c.height,
          ...
          d = d || {};
          var e = d.data = d.data || {}, g = d.garbageCollect = d.garbageCollect || [];
          ...
          for (c = 0, d = a.length; c < d; ++c) if (e = a[c], g = b[c], e instanceof Array && g instanceof Array) {
    ...
    }, {2: 2}], 27: [function (a, b, c) {
      "use strict";
      b.exports = function () {
        var a = function (b, c) {
          var d = this, e = a.helpers;
        ...
        a.layoutService = {
          defaults: {}, addBox: function (a, b) {
            ...
            function f(a) {
              ...
              if (c) if (a.isHorizontal()) {
                var d = {left: x, right: y, top: 0, bottom: 0};
            ...
            function g(a) {
              var c = b.findNextWhere(w, function (b) {
                return b.box === a
              }), d = {left: 0, right: 0, top: z, bottom: A};
            ...
            if (a) {
              var i = 0, j = b.where(a.boxes, function (a) {
              ...
              var o = c - 2 * i, p = d - 0, q = o / 2, r = p / 2, s = (c - q) / (j.length + k.length),
                t = (d - r) / (l.length + m.length), u = o, v = p, w = [];
      ...
      b.exports = function (a) {
        ...
        a.defaults.global.legend = {
          display: !0, position: "top", fullWidth: !0, reverse: !1, onClick: function (a, b) {
            var c = b.datasetIndex, d = this.chart, e = d.getDatasetMeta(c);
            e.hidden = null === e.hidden ? !d.data.datasets[c].hidden : null, d.update()
          }, labels: {
            boxWidth: 40, padding: 10, generateLabels: function (a) {
              var c = a.data;
          ...
          initialize: function (a) {
          ...
          }, beforeUpdate: c, update: function (a, b, c) {
            var d = this;
          ...
          }, afterUpdate: c, beforeSetDimensions: c, setDimensions: function () {
            var a = this;
          ...
          }, afterSetDimensions: c, beforeBuildLabels: c, buildLabels: function () {
            var a = this;
            a.legendItems = a.options.labels.generateLabels.call(a, a.chart), a.options.reverse && a.legendItems.reverse()
          }, afterBuildLabels: c, beforeFit: c, fit: function () {
            var c = this, d = c.options, e = d.labels, f = d.display, g = c.ctx, h = a.defaults.global,
              i = b.getValueOrDefault, j = i(e.fontSize, h.defaultFontSize), k = i(e.fontStyle, h.defaultFontStyle),
              l = i(e.fontFamily, h.defaultFontFamily), m = b.fontString(j, k, l), n = c.legendHitBoxes = [],
              o = c.minSize, p = c.isHorizontal();
            if (p ? (o.width = c.maxWidth, o.height = f ? 10 : 0) : (o.width = f ? 10 : 0, o.height = c.maxHeight), f) if (g.font = m, p) {
              var q = c.lineWidths = [0], r = c.legendItems.length ? j + e.padding : 0;
              g.textAlign = "left", g.textBaseline = "top", b.each(c.legendItems, function (a, b) {
                var d = e.usePointStyle ? j * Math.sqrt(2) : e.boxWidth, f = d + j / 2 + g.measureText(a.text).width;
              ...
              var s = e.padding, t = c.columnWidths = [], u = e.padding, v = 0, w = 0, x = j + s;
              b.each(c.legendItems, function (a, b) {
                var c = e.usePointStyle ? 2 * e.boxWidth : e.boxWidth, d = c + j / 2 + g.measureText(a.text).width;
          ...
          }, afterFit: c, isHorizontal: function () {
            return "top" === this.options.position || "bottom" === this.options.position
          }, draw: function () {
            var c = this, d = c.options, e = d.labels, f = a.defaults.global, g = f.elements.line, h = c.width,
              i = c.lineWidths;
            if (d.display) {
              var j, k = c.ctx, l = b.getValueOrDefault, m = l(e.fontColor, f.defaultFontColor),
                n = l(e.fontSize, f.defaultFontSize), o = l(e.fontStyle, f.defaultFontStyle),
                p = l(e.fontFamily, f.defaultFontFamily), q = b.fontString(n, o, p);
              k.textAlign = "left", k.textBaseline = "top", k.lineWidth = .5, k.strokeStyle = m, k.fillStyle = m, k.font = q;
              var r = e.boxWidth, s = c.legendHitBoxes, t = function (b, c, e) {
                if (!(isNaN(r) || r <= 0)) {
                  if (k.save(), k.fillStyle = l(e.fillStyle, f.defaultColor), k.lineCap = l(e.lineCap, g.borderCapStyle), k.lineDashOffset = l(e.lineDashOffset, g.borderDashOffset), k.lineJoin = l(e.lineJoin, g.borderJoinStyle), k.lineWidth = l(e.lineWidth, g.borderWidth), k.strokeStyle = l(e.strokeStyle, f.defaultColor), k.setLineDash && k.setLineDash(l(e.lineDash, g.borderDash)), d.labels && d.labels.usePointStyle) {
                    var h = n * Math.SQRT2 / 2, i = h / Math.SQRT2, j = b + i, m = c + i;
              ...
              j = v ? {x: c.left + (h - i[0]) / 2, y: c.top + e.padding, line: 0} : {
                x: c.left + e.padding,
                y: c.top + e.padding,
                line: 0
              };
              var w = n + e.padding;
              b.each(c.legendItems, function (a, b) {
                var d = k.measureText(a.text).width, f = e.usePointStyle ? n + n / 2 + d : r + n / 2 + d, g = j.x,
                  l = j.y;
            ...
            var c = this, d = b.getRelativePosition(a, c.chart.chart), e = d.x, f = d.y, g = c.options;
            if (e >= c.left && e <= c.right && f >= c.top && f <= c.bottom) for (var h = c.legendHitBoxes, i = 0; i < h.length; ++i) {
              var j = h[i];
      ...
      b.exports = function (a) {
        ...
        a.plugins = {
          _plugins: [], register: function (a) {
            ...
            var c, d, e = this._plugins, f = e.length;
            for (c = 0; c < f; ++c) if (d = e[c], "function" == typeof d[a] && !1 === d[a].apply(d, b || [])) return !1;
            return !0
          }
      ...
      b.exports = function (a) {
        ...
        a.defaults.scale = {
          ...
          calculateTickRotation: function () {
            var c = this, d = c.ctx, e = a.defaults.global, f = c.options.ticks,
              g = b.getValueOrDefault(f.fontSize, e.defaultFontSize),
              h = b.getValueOrDefault(f.fontStyle, e.defaultFontStyle),
              i = b.getValueOrDefault(f.fontFamily, e.defaultFontFamily), j = b.fontString(g, h, i);
            d.font = j;
            var k, l = d.measureText(c.ticks[0]).width, m = d.measureText(c.ticks[c.ticks.length - 1]).width;
          ...
          fit: function () {
            var c = this, d = c.minSize = {width: 0, height: 0}, e = c.options, f = a.defaults.global, g = e.ticks,
              h = e.scaleLabel, i = e.display, j = c.isHorizontal(),
              k = b.getValueOrDefault(g.fontSize, f.defaultFontSize),
              l = b.getValueOrDefault(g.fontStyle, f.defaultFontStyle),
              m = b.getValueOrDefault(g.fontFamily, f.defaultFontFamily), n = b.fontString(k, l, m),
              o = b.getValueOrDefault(h.fontSize, f.defaultFontSize), p = e.gridLines.tickMarkLength;
            if (d.width = j ? c.isFullWidth() ? c.maxWidth - c.margins.left - c.margins.right : c.maxWidth : i ? p : 0, d.height = j ? i ? p : 0 : c.maxHeight, h.display && i && (j ? d.height += 1.5 * o : d.width += 1.5 * o), g.display && i) {
              ...
              var q = b.longestText(c.ctx, n, c.ticks, c.longestTextCache), r = b.numberOfLabelLines(c.ticks),
                s = .5 * k;
              if (j) {
                ...
                var u = c.ctx.measureText(c.ticks[0]).width, v = c.ctx.measureText(c.ticks[c.ticks.length - 1]).width,
                  w = Math.cos(b.toRadians(c.labelRotation)), x = Math.sin(b.toRadians(c.labelRotation));
          ...
          getPixelForDecimal: function (a) {
            var b = this;
            if (b.isHorizontal()) {
              var c = b.width - (b.paddingLeft + b.paddingRight), d = c * a + b.paddingLeft, e = b.left + Math.round(d);
              return e += b.isFullWidth() ? b.margins.left : 0
            }
            return b.top + a * b.height
          },
          getBasePixel: function () {
            var a = this, b = a.min, c = a.max;
            return a.getPixelForValue(a.beginAtZero ? 0 : b < 0 && c < 0 ? c : b > 0 && c > 0 ? b : 0)
          },
          draw: function (c) {
            var d = this, e = d.options;
            if (e.display) {
              var f, g, h = d.ctx, i = a.defaults.global, j = e.ticks, k = e.gridLines, l = e.scaleLabel,
                m = 0 !== d.labelRotation, n = j.autoSkip, o = d.isHorizontal();
              ...
              var p = b.getValueOrDefault(j.fontColor, i.defaultFontColor),
                ...
                s = b.getValueOrDefault(j.fontFamily, i.defaultFontFamily), t = b.fontString(q, r, s),
                u = k.tickMarkLength, v = b.getValueOrDefault(l.fontColor, i.defaultFontColor),
                w = b.getValueOrDefault(l.fontSize, i.defaultFontSize),
                x = b.getValueOrDefault(l.fontStyle, i.defaultFontStyle),
                y = b.getValueOrDefault(l.fontFamily, i.defaultFontFamily), z = b.fontString(w, x, y),
                A = b.toRadians(d.labelRotation), B = Math.cos(A), C = d.longestLabelWidth * B;
              h.fillStyle = p;
              var D = [];
              if (o) {
                if (f = !1, m && (C /= 2), (C + j.autoSkipPadding) * d.ticks.length > d.width - (d.paddingLeft + d.paddingRight) && (f = 1 + Math.floor((C + j.autoSkipPadding) * d.ticks.length / (d.width - (d.paddingLeft + d.paddingRight)))), g && d.ticks.length > g) for (; !f || d.ticks.length / (f || 1) > g;) f || (f = 1), f += 1;
                n || (f = !1)
              }
              var E = "right" === e.position ? d.left : d.right - u, F = "right" === e.position ? d.left + u : d.right,
                G = "bottom" === e.position ? d.top : d.bottom - u, H = "bottom" === e.position ? d.top + u : d.bottom;
              if (b.each(d.ticks, function (a, g) {
                ...
                if (k.display && (h.lineWidth = a.glWidth, h.strokeStyle = a.glColor, h.beginPath(), k.drawTicks && (h.moveTo(a.tx1, a.ty1), h.lineTo(a.tx2, a.ty2)), k.drawOnChartArea && (h.moveTo(a.x1, a.y1), h.lineTo(a.x2, a.y2)), h.stroke()), j.display) {
                  ...
                  var c = a.label;
                  if (b.isArray(c)) for (var d = 0, e = 0; d < c.length; ++d) h.fillText("" + c[d], 0, e), e += 1.5 * q; else h.fillText(c, 0, 0);
                  h.restore()
                }
              }), l.display) {
                var I, J, K = 0;
                if (o) I = d.left + (d.right - d.left) / 2, J = "bottom" === e.position ? d.bottom - w / 2 : d.top + w / 2; else {
              ...
              if (k.drawBorder) {
                ...
                var M = d.left, N = d.right, O = d.top, P = d.bottom, Q = b.aliasPixel(h.lineWidth);
      ...
      b.exports = function (a) {
        var b = a.helpers;
        a.scaleService = {
          constructors: {}, defaults: {}, registerScaleType: function (a, c, d) {
      ...
      b.exports = function (a) {
        ...
        a.Title = a.Element.extend({
          ...
          beforeFit: c,
          fit: function () {
            var c = this, d = b.getValueOrDefault, e = c.options, f = a.defaults.global, g = e.display,
              h = d(e.fontSize, f.defaultFontSize), i = c.minSize;
          ...
          draw: function () {
            var c = this, d = c.ctx, e = b.getValueOrDefault, f = c.options, g = a.defaults.global;
            if (f.display) {
              var h, i, j = e(f.fontSize, g.defaultFontSize), k = e(f.fontStyle, g.defaultFontStyle),
                l = e(f.fontFamily, g.defaultFontFamily), m = b.fontString(j, k, l), n = 0, o = c.top, p = c.left,
                q = c.bottom, r = c.right;
      ...
      b.exports = function (a) {
        ...
        function c(a) {
          ...
          return {x: Math.round(h / d.length), y: Math.round(i / d.length)}
        }

        function d(a) {
          var b = a._xScale, c = a._yScale || a._scale, d = a._index, e = a._datasetIndex;
          return {
        ...
        a.defaults.global.tooltips = {
          ...
          callbacks: {
            beforeTitle: e.noop, title: function (a, b) {
              var c = "", d = b.labels, e = d ? d.length : 0;
              if (a.length > 0) {
                var f = a[0];
                f.xLabel ? c = f.xLabel : e > 0 && f.index < e && (c = d[f.index])
              }
              return c
            }, afterTitle: e.noop, beforeBody: e.noop, beforeLabel: e.noop, label: function (a, b) {
              return (b.datasets[a.datasetIndex].label || "") + ": " + a.yLabel
            }, labelColor: function (a, b) {
              var c = b.getDatasetMeta(a.datasetIndex), d = c.data[a.index], e = d._view;
              return {borderColor: e.borderColor, backgroundColor: e.backgroundColor}
            }, afterLabel: e.noop, afterBody: e.noop, beforeFooter: e.noop, footer: e.noop, afterFooter: e.noop
          }
        }, a.Tooltip = a.Element.extend({
          initialize: function () {
            var b = this, c = a.defaults.global, d = b._options, f = e.getValueOrDefault;
            e.extend(b, {
              _model: {
                xPadding: d.xPadding,
                yPadding: d.yPadding,
            ...
            var a = this, c = a._options, d = c.callbacks, e = d.beforeTitle.apply(a, arguments),
              f = d.title.apply(a, arguments), g = d.afterTitle.apply(a, arguments), h = [];
            ...
            var d = this, f = d._options.callbacks, g = [];
            ...
            var a = this, c = a._options.callbacks, d = c.beforeFooter.apply(a, arguments),
              e = c.footer.apply(a, arguments), f = c.afterFooter.apply(a, arguments), g = [];
            return g = b(g, d), g = b(g, e), g = b(g, f)
          }, update: function (a) {
            var b, f, g = this, h = g._options, i = g._model, j = g._active, k = g._data, l = g._chartInstance;
            if (j.length) {
              i.opacity = 1;
              var m = [], n = c(j), o = [];
            ...
            var b = this._chart.ctx, c = {height: 2 * a.yPadding, width: 0}, d = a.body, f = d.reduce(function (a, b) {
              return a + b.before.length + b.lines.length + b.after.length
            }, 0);
            f += a.beforeBody.length + a.afterBody.length;
            var g = a.title.length, h = a.footer.length, i = a.titleFontSize, j = a.bodyFontSize, k = a.footerFontSize;
            ...
            var b = this, c = b._model, d = b._chart, e = b._chartInstance.chartArea;
            c.y < a.height ? c.yAlign = "top" : c.y > d.height - a.height && (c.yAlign = "bottom");
            var f, g, h, i, j, k = (e.left + e.right) / 2, l = (e.top + e.bottom) / 2;
            ...
            var c = {x: a.x, y: a.y}, d = a.caretSize, e = a.caretPadding, f = a.cornerRadius, g = a.xAlign,
              h = a.yAlign, i = d + e, j = f + e;
            ...
            var d, f, g, h, i, j, k = this._view, l = this._chart.ctx, m = k.caretSize, n = k.cornerRadius,
              o = k.xAlign, p = k.yAlign, q = a.x, r = a.y, s = b.width, t = b.height;
            ...
            if (f.length) {
              ...
              var g = b.titleFontSize, h = b.titleSpacing, i = e.color(b.titleFontColor);
            ...
            var f = b.bodyFontSize, g = b.bodySpacing, h = b.body;
            c.textAlign = b._bodyAlign, c.textBaseline = "top";
            var i = e.color(b.bodyFontColor), j = i.alpha(d * i.alpha()).rgbString();
            c.fillStyle = j, c.font = e.fontString(f, b._bodyFontStyle, b._bodyFontFamily);
            var k = 0, l = function (b) {
            ...
            var a = this._chart.ctx, b = this._view;
            if (0 !== b.opacity) {
              var c = this.getTooltipSize(b), d = {x: b.x, y: b.y}, f = Math.abs(b.opacity < .001) ? 0 : b.opacity;
      ...
      "use strict";
      b.exports = function (a) {
        var b = a.helpers, c = a.defaults.global;
        c.elements.arc = {
          ...
          inLabelRange: function (a) {
            ...
            if (d) {
              ...
              for (; f > i;) f -= 2 * Math.PI;
              for (; f < h;) f += 2 * Math.PI;
              var j = f >= h && f <= i, k = g >= d.innerRadius && g <= d.outerRadius;
              return j && k
            }
            return !1
          }, tooltipPosition: function () {
            var a = this._view, b = a.startAngle + (a.endAngle - a.startAngle) / 2,
              c = (a.outerRadius - a.innerRadius) / 2 + a.innerRadius;
            return {x: a.x + Math.cos(b) * c, y: a.y + Math.sin(b) * c}
          }, draw: function () {
            var a = this._chart.ctx, b = this._view, c = b.startAngle, d = b.endAngle;
      ...
      b.exports = function (a) {
        ...
        a.defaults.global.elements.line = {
          ...
          draw: function () {
            ...
            var d = this, e = d._view, f = e.spanGaps, g = e.scaleZero, h = d._loop, i = d._chart.ctx;
            i.save();
            var j = d._children.slice(), k = -1;
      ...
      "use strict";
      b.exports = function (a) {
        var b = a.helpers, c = a.defaults.global, d = c.defaultColor;
        c.elements.point = {
          radius: 3,
          pointStyle: "circle",
          backgroundColor: d,
          ...
          inRange: function (a, b) {
            ...
            var e = this._view, f = this._chart.ctx, g = e.pointStyle, h = e.radius, i = e.x, j = e.y;
      ...
      b.exports = function (a) {
        ...
        b.elements.rectangle = {
          ...
          draw: function () {
            ...
            var b = this._chart.ctx, c = this._view, d = c.width / 2, e = c.x - d, f = c.x + d,
              g = c.base - (c.base - c.y), h = c.borderWidth / 2;
            c.borderWidth && (e += h, f -= h, g += h), b.beginPath(), b.fillStyle = c.backgroundColor, b.strokeStyle = c.borderColor, b.lineWidth = c.borderWidth;
            var i = [[e, c.base], [e, g], [f, g], [f, c.base]], j = ["bottom", "left", "top", "right"],
              k = j.indexOf(c.borderSkipped, 0);
            -1 === k && (k = 0), b.moveTo.apply(b, a(0));
            for (var l = 1; l < 4; l++) b.lineTo.apply(b, a(l));
            b.fill(), c.borderWidth && b.stroke()
      ...
      b.exports = function (a) {
        var b = a.helpers, c = {position: "bottom"}, d = a.Scale.extend({
          getLabels: function () {
            ...
            var e = this, f = Math.max(e.maxIndex + 1 - e.minIndex - (e.options.gridLines.offsetGridLines ? 0 : 1), 1);
            if (void 0 !== a) {
              var g = e.getLabels(), h = g.indexOf(a);
              b = -1 !== h ? h : b
            }
            if (e.isHorizontal()) {
              var i = e.width - (e.paddingLeft + e.paddingRight), j = i / f, k = j * (b - e.minIndex) + e.paddingLeft;
              return e.options.gridLines.offsetGridLines && d && (k += j / 2), e.left + Math.round(k)
            }
            var l = e.height - (e.paddingTop + e.paddingBottom), m = l / f, n = m * (b - e.minIndex) + e.paddingTop;
            ...
            var b = this, c = Math.max(b.ticks.length - (b.options.gridLines.offsetGridLines ? 0 : 1), 1),
              d = b.isHorizontal(),
      ...
      b.exports = function (a) {
        var b = a.helpers, c = {
          ...
          determineDataLimits: function () {
            ...
            var c = this, d = c.options, e = c.chart, f = e.data, g = f.datasets, h = c.isHorizontal();
            if (c.min = null, c.max = null, d.stacked) {
              var i = {}, j = !1, k = !1;
              b.each(g, function (f, g) {
                var h = e.getDatasetMeta(g);
                void 0 === i[h.type] && (i[h.type] = {positiveValues: [], negativeValues: []});
                var l = i[h.type].positiveValues, m = i[h.type].negativeValues;
                ...
                var d = a.positiveValues.concat(a.negativeValues), e = b.min(d), f = b.max(d);
            ...
            var c, d = this, e = d.options.ticks;
            if (d.isHorizontal()) c = Math.min(e.maxTicksLimit ? e.maxTicksLimit : 11, Math.ceil(d.width / 50)); else {
            ...
            var b, c, d = this, e = d.paddingLeft, f = d.paddingBottom, g = d.start, h = +d.getRightValue(a),
              i = d.end - g;
            ...
            var b = this, c = b.isHorizontal(), d = b.paddingLeft, e = b.paddingBottom,
      ...
      b.exports = function (a) {
        ...
        a.LinearScaleBase = a.Scale.extend({
          handleTickRangeOptions: function () {
            var a = this, c = a.options, d = c.ticks;
            if (d.beginAtZero) {
              var e = b.sign(a.min), f = b.sign(a.max);
          ...
          }, getTickLimit: c, handleDirectionalChanges: c, buildTicks: function () {
            var a = this, c = a.options, d = a.ticks = [], e = c.ticks, f = b.getValueOrDefault, g = a.getTickLimit();
            g = Math.max(2, g);
            var h;
            if (e.fixedStepSize && e.fixedStepSize > 0 || e.stepSize && e.stepSize > 0) h = f(e.fixedStepSize, e.stepSize); else {
              var i = b.niceNum(a.max - a.min, !1);
              h = b.niceNum(i / (g - 1), !0)
            }
            var j = Math.floor(a.min / h) * h, k = Math.ceil(a.max / h) * h, l = (k - j) / h;
      ...
      b.exports = function (a) {
        var b = a.helpers, c = {
          ...
          determineDataLimits: function () {
            ...
            var c = this, d = c.options, e = d.ticks, f = c.chart, g = f.data, h = g.datasets, i = b.getValueOrDefault,
              j = c.isHorizontal();
            if (c.min = null, c.max = null, d.stacked) {
              var k = {};
            ...
            for (var a = this, c = a.options, d = c.ticks, e = b.getValueOrDefault, f = a.ticks = [], g = e(d.min, Math.pow(10, Math.floor(b.log10(a.min)))); g < a.max;) {
              f.push(g);
              var h = Math.floor(b.log10(g)), i = Math.floor(g / Math.pow(10, h)) + 1;
            ...
            var c, d, e = this, f = e.start, g = +e.getRightValue(a), h = b.log10(e.end) - b.log10(f), i = e.paddingTop,
              j = e.paddingBottom, k = e.paddingLeft;
            ...
            var c, d, e = this, f = b.log10(e.end) - b.log10(e.start);
      ...
      "use strict";
      b.exports = function (a) {
        var b = a.helpers, c = a.defaults.global, d = {
          display: !0,
          animate: !0,
          lineArc: !1,
          position: "chartArea",
          ...
          pointLabels: {
            fontSize: 10, callback: function (a) {
              return a
            }
          }
          ...
          getValueCount: function () {
            ...
            var a = this, d = a.options, e = d.ticks;
            a.width = a.maxWidth, a.height = a.maxHeight, a.xCenter = Math.round(a.width / 2), a.yCenter = Math.round(a.height / 2);
            var f = b.min([a.height, a.width]), g = b.getValueOrDefault(e.fontSize, c.defaultFontSize);
            ...
            var a = this.options.ticks, d = b.getValueOrDefault(a.fontSize, c.defaultFontSize);
            ...
            var a, d, e, f, g, h, i, j, k, l, m, n, o = this.options.pointLabels,
              ...
              r = b.getValueOrDefault(o.fontFamily, c.defaultFontFamily), s = b.fontString(p, q, r),
              t = b.min([this.height / 2 - p - 5, this.width / 2]), u = this.width, v = 0;
            for (this.ctx.font = s, d = 0; d < this.getValueCount(); d++) {
              ...
              var w = this.getIndexAngle(d) + Math.PI / 2, x = 360 * w / (2 * Math.PI) % 360;
            ...
            var c = this, d = c.width - b - c.drawingArea, e = a + c.drawingArea;
            ...
            var c = this, d = c.getIndexAngle(a);
            return {x: Math.round(Math.cos(d) * b) + c.xCenter, y: Math.round(Math.sin(d) * b) + c.yCenter}
            ...
            var a = this, d = a.options, e = d.gridLines, f = d.ticks, g = d.angleLines, h = d.pointLabels,
              i = b.getValueOrDefault;
            if (d.display) {
              var j = a.ctx, k = i(f.fontSize, c.defaultFontSize), l = i(f.fontStyle, c.defaultFontStyle),
                m = i(f.fontFamily, c.defaultFontFamily), n = b.fontString(k, l, m);
              if (b.each(a.ticks, function (g, h) {
                if (h > 0 || d.reverse) {
                  var l = a.getDistanceFromCenterForValue(a.ticksAsNumbers[h]), m = a.yCenter - l;
                  if (e.display && 0 !== h) if (j.strokeStyle = b.getValueAtIndexOrDefault(e.color, h - 1), j.lineWidth = b.getValueAtIndexOrDefault(e.lineWidth, h - 1), d.lineArc) j.beginPath(), j.arc(a.xCenter, a.yCenter, l, 0, 2 * Math.PI), j.closePath(), j.stroke(); else {
                    j.beginPath();
                ...
                for (var o = a.getDistanceFromCenterForValue(d.reverse ? a.min : a.max), p = i(h.fontSize, c.defaultFontSize), q = i(h.fontStyle, c.defaultFontStyle), r = i(h.fontFamily, c.defaultFontFamily), s = b.fontString(p, q, r), t = a.getValueCount() - 1; t >= 0; t--) {
                  ...
                  var v = a.getPointPosition(t, o + 5), w = i(h.fontColor, c.defaultFontColor);
                  j.font = s, j.fillStyle = w;
                  var x = a.pointLabels, y = this.getIndexAngle(t) + Math.PI / 2, z = 360 * y / (2 * Math.PI) % 360;
        ...
        var b = a.helpers, c = {
          ...
          initialize: function () {
            ...
            a.chart.data.labels && a.chart.data.labels.length > 0 ? (b.each(a.chart.data.labels, function (b) {
              ...
              var g = [], h = a.chart.isDatasetVisible(f);
            ...
            if (d.ctx.font = h, d.ticks = [], d.unitScale = 1, d.scaleSizeInUnits = 0, d.options.time.unit) d.tickUnit = d.options.time.unit || "day", d.displayFormat = d.options.time.displayFormats[d.tickUnit], d.scaleSizeInUnits = d.lastTick.diff(d.firstTick, d.tickUnit, !0), d.unitScale = b.getValueOrDefault(d.options.time.unitStepSize, 1); else {
              var i = d.isHorizontal() ? d.width - (d.paddingLeft + d.paddingRight) : d.height - (d.paddingTop + d.paddingBottom),
                j = d.tickFormatFunction(d.firstTick, 0, []), k = d.ctx.measureText(j).width;
              ...
              for (var m = 0, n = c.units[m]; m < c.units.length;) {
                if (d.unitScale = 1, b.isArray(n.steps) && Math.ceil(d.scaleSizeInUnits / l) < b.max(n.steps)) {
                  for (var o = 0; o < n.steps.length; ++o) if (n.steps[o] >= Math.ceil(d.scaleSizeInUnits / l)) {
            ...
            if (d.options.time.min ? r = d.getMomentStartOf(d.firstTick) : (d.firstTick = d.getMomentStartOf(d.firstTick), r = d.firstTick), !d.options.time.max) {
              var s = d.getMomentStartOf(d.lastTick), t = s.diff(d.lastTick, d.tickUnit, !0);
            ...
            var c = this, d = c.chart.data.labels && a < c.chart.data.labels.length ? c.chart.data.labels[a] : "";
            ...
            var e = a.format(this.displayFormat), f = this.options.ticks,
            ...
            if (f) {
              var g = f.diff(e.firstTick, e.tickUnit, !0), h = 0 !== g ? g / e.scaleSizeInUnits : g;
              if (e.isHorizontal()) {
                var i = e.width - (e.paddingLeft + e.paddingRight), j = i * h + e.paddingLeft;
                return e.left + Math.round(j)
              }
              var k = e.height - (e.paddingTop + e.paddingBottom), l = k * h + e.paddingTop;
